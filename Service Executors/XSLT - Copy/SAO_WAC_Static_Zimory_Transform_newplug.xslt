...
<farm>
  ...
  <numberofusers>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Number of Users']"/><![CDATA[</numberofusers>
  <purpose>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Purpose']"/><![CDATA[</purpose>
  
  
  <farmname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Short Customer Name']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Purpose']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Location']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[</farmname>
  ...
  <location>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Location']"/><![CDATA[</location>
  <customer>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Name']"/><![CDATA[</customer>
  <customerabreviation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Short Customer Name']"/><![CDATA[</customerabreviation>
  <passphrase>1#]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Short Customer Name']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Purpose']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Location']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[#1</passphrase>
  ...
  <amountindexeditems>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Amount of Indexed Items']"/><![CDATA[</amountindexeditems>
  ...
  <domainjoinsettings>
    <settings>
      <shortdomainame>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DOMAINJOIN_SNAME']"/><![CDATA[</shortdomainame>
      <forestdomainname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DOMAINJOIN_FNAME']"/><![CDATA[</forestdomainname>
      <dcip>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DC_IP_ADDRESS']"/><![CDATA[</dcip>
      <username>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DOMAINJOIN_USERNAME']"/><![CDATA[</username>
      <password>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DOMAINJOIN_PASSWORD']"/><![CDATA[</password>
      <localadminpassword>Start123</localadminpassword>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_DOMAINJOIN_OU']"/><![CDATA[</ou>
    </settings>
  </domainjoinsettings>
  ...
  <managedaccounts>
    <managedaccount>
     ]]><xsl:variable name="userdomainSPIA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPIA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPIA" select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_SP_INSTALL_PASSWORD']"></xsl:variable>
    <![CDATA[
    ...
    <managedaccount>
    ]]><xsl:variable name="userdomainSPFA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Farm Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPFA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Farm Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
     ]]><xsl:variable name="userdomainSPWA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Web Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPWA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Web Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainSPSA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Service App Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPSA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Service App Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
     ]]><xsl:variable name="userdomainSQL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Server Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Server Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Agent Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQLA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Agent Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
             ]]><xsl:variable name="userdomainSQLI" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Install Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQLI" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SQL Install Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
                ]]><xsl:variable name="userdomainSPCA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Cache Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPCA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Cache Admin Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
    ]]><xsl:variable name="userdomainSPCR" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Cache Reader Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPCR" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Cache Reader Account'],'\'))"></xsl:variable>
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainCRAWL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Crawl Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordCRAWL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP Crawl Account'],'\'))"></xsl:variable>
...
<domain>]]><xsl:value-of select="$userdomainCRAWL"/><![CDATA[</domain>
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainTSYS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP TSYS Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordTSYS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='SP TSYS Admin Account'],'\'))"></xsl:variable>
  ...
  <xsl:for-each select="//zim:set[@plugin='srv_base_es']/zim:item[@name='serviceextensions']/serviceextension">
      <xsl:if test="name!=''">
        <![CDATA[
  ...
  <webapplications>
    <webapplication>
      <name>Search</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Search Center URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_Search_SPContent</contentDBPrefix>
      ...
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <sitecollections>
    <sitecollection>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Search Center URL']"/><![CDATA[/sites/teamcollab</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <sitecollection>
      <webapplication>Search</webapplication>
      <name>Users</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Search Center URL']"/><![CDATA[/userprofiles</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <serviceapplicationsettings>
    <serviceapplicationsetting>
      ...
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 1']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
    <serviceapplicationsetting>
      <serviceapplicationname>Managed Metadata Service</serviceapplicationname>
      <settingname>TermStoreAdministrator</settingname>
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Customer Admin 2']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
<serviceapplicationsetting>
  ...
  <userprofileservicesettings>
   ]]><xsl:variable name="domainUPS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import Account'],'\'))"></xsl:variable>
  <xsl:variable name="usernameandpasswordUPS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import Account'],'\'))"></xsl:variable>
  ...
  <xsl:variable name="passwordUPS" select="normalize-space(substring-after($usernameandpasswordUPS,':'))"></xsl:variable><![CDATA[
    <userprofileservicesetting>
      <connectorname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import Domain']"/><![CDATA[</connectorname>
      <forestname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import Forest']"/><![CDATA[</forestname>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import OU']"/><![CDATA[</ou>
      <importfilter>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Profile Import Filter']"/><![CDATA[</importfilter>
      <useraccount>]]><xsl:value-of select="$usernameUPS"/><![CDATA[</useraccount>
      <password>]]><xsl:value-of select="$passwordUPS"/><![CDATA[</password>
      <mysitehostlocation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='Search Center URL']"/><![CDATA[/userprofiles</mysitehostlocation>
  ...
  <contentsources>
    ...
    <xsl:variable name="hostonlysearchcentreurl" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='Search Center URL'],'://'))"></xsl:variable>
    <![CDATA[
  <contentsource>
    ...
    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_WEB']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_WEB']"/>
        <xsl:with-param name="type" select="'Web'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_FILE']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_FILE']"/>
        <xsl:with-param name="type" select="'File'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_BUSINESS']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_BUSINESS']"/>
        <xsl:with-param name="type" select="'Business'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_SP']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CONTENT_SP']"/>
...
-->
  ...
  <featureactivations>
    ...
    <wacconfiguration>
      <sharepointip>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_SPFARM_IP_ADDRESS']"/><![CDATA[</sharepointip>
      <translationenabled>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_TRANSLATIONENABLED']"/><![CDATA[</translationenabled>
      <editingenabled>]]><xsl:value-of select="//zim:set[@plugin='srv_base_wac']/zim:item[@name='_conf_EDITINGENABLED']"/><![CDATA[</editingenabled>      
    </wacconfiguration>
