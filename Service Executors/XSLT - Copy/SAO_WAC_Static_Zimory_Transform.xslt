...
<farm>
  ...
  <domainjoinsettings>
    <settings>
      <shortdomainame>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DOMAINJOIN_SNAME']"/><![CDATA[</shortdomainame>
      <forestdomainname>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DOMAINJOIN_FNAME']"/><![CDATA[</forestdomainname>
      <dcip>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DC_IP_ADDRESS']"/><![CDATA[</dcip>
      <username>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DOMAINJOIN_USERNAME']"/><![CDATA[</username>
      <password>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DOMAINJOIN_PASSWORD']"/><![CDATA[</password>
      <localadminpassword>Start123</localadminpassword>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_DOMAINJOIN_OU']"/><![CDATA[</ou>
    </settings>
  </domainjoinsettings>
 ...
 <servergroups>
  ...
  <managedaccounts>
    <managedaccount>
     ]]><xsl:variable name="userdomainSPIA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPIA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPIA" select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_SP_INSTALL_PASSWORD']"></xsl:variable>
    <![CDATA[
...
-->
  ...
  <featureactivations>
    ...
    <wacconfiguration>
      <sharepointip>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_SPFARM_IP_ADDRESS']"/><![CDATA[</sharepointip>
      <translationenabled>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_TRANSLATIONENABLED']"/><![CDATA[</translationenabled>
      <editingenabled>]]><xsl:value-of select="//zim:set[@plugin='SAO-WAC-Base']/zim:item[@name='_conf_EDITINGENABLED']"/><![CDATA[</editingenabled>      
    </wacconfiguration>
