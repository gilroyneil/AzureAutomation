...
<BlobCacheLocation>]]><xsl:value-of select="farm/blobcachelocation"/><![CDATA[</BlobCacheLocation>  
    ...
    select="aliasname">
      ...
      <![CDATA[<SQLAlias>]]><xsl:value-of select="aliasname"/><![CDATA[</SQLAlias>
		...
		<DataDrive2>h</DataDrive2> 
                <LogsDrive>i</LogsDrive>
               <LogsDrive2>i</LogsDrive2>
                <TempDBDataDrive>i</TempDBDataDrive>
                <TempDBLogsDrive>i</TempDBLogsDrive>
                <SystemDBDrive>i</SystemDBDrive>
        ...
        <xsl:otherwise>
          <![CDATA[
          <DataDrive>h</DataDrive>
		<DataDrive2>i</DataDrive2>
                 <LogsDrive>j</LogsDrive>
               <LogsDrive2>j</LogsDrive2>
                <TempDBDataDrive>k</TempDBDataDrive>
                <TempDBLogsDrive>l</TempDBLogsDrive>
    ...
    <AlwaysOnSettings>
        ...
        <ClusterIPs>]]><xsl:value-of select="//clusterconfiguration/updatedclusterconfiguration_cluster[servername=$serverNameForAlias]/ipandsubnet"/><![CDATA[</ClusterIPs>   
        <ClusterName>]]><xsl:value-of select="//clusterconfiguration/updatedclusterconfiguration_cluster[servername=$serverNameForAlias]/clustername"/><![CDATA[</ClusterName>        
    ...
    <!--
      ...
      <ListenerIPs>]]><xsl:value-of select="farm/clusterconfiguration/listenerip"/><![CDATA[</ListenerIPs>
        ...
        <ClusterQuoromShare></ClusterQuoromShare>
        <Node1SQLBackupShare></Node1SQLBackupShare>
        <EndpointName>AlwaysOn_Endpoint</EndpointName>
...
<SessionDetailServerTable>]]><xsl:value-of select="normalize-space(//azureconfiguration/sessiondetailservertable)"/><![CDATA[</SessionDetailServerTable>        
	...
	<SharePointBackup>
        ...
        <BackupDriveLetter>]]><xsl:value-of select="normalize-space(//backupandmaintenancesettings/backupdriveletter)"/><![CDATA[</BackupDriveLetter>
