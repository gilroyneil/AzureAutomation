...
<farm>
  ...
  <installSSRS>]]><xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_INSTALL_SSRS'] = 'true'"><![CDATA[true]]></xsl:if><![CDATA[</installSSRS>
  ...
  <devseat>]]><xsl:choose>
    <xsl:when test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_PURPOSE'] = 'DES'">True</xsl:when>
...
<overideIndexItemCountWithThisValue>0</overideIndexItemCountWithThisValue>
  ...
  <farmnumber>1</farmnumber>
    ...
    <xsl:when test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_PURPOSE'] = 'DES' and //customerandenvironmentsettings/devseatisdc = 'True'">Yes</xsl:when>
    <xsl:otherwise>No</xsl:otherwise>
  </xsl:choose><![CDATA[</createdomain>
    <joindomain>]]><xsl:choose>
    <xsl:when test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_PURPOSE'] = 'DES' and //customerandenvironmentsettings/devseatisdc = 'True'">No</xsl:when>
...
<servergroup>
	...
	<hdrivevhdsize/>
      ...
      <ldrivevhdsize/>
      <mdrivevhdsize/>
      <ndrivevhdsize>20</ndrivevhdsize>
...
<servergroup>
    ...
    <cdrivevhdsize>40</cdrivevhdsize>
      <edrivevhdsize>20</edrivevhdsize>
      <fdrivevhdsize>30</fdrivevhdsize>   
      <idrivevhdsize/>
      <nicservice>x</nicservice>
      <nicoperations>x</nicoperations>
      <nicbackup>x</nicbackup>
   ...
   <cdrivevhdsize>100</cdrivevhdsize>
    ...
    <cdrivevhdsize>40</cdrivevhdsize>
      <edrivevhdsize>20</edrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <hdrivevhdsize>20</hdrivevhdsize>
      <idrivevhdsize>10</idrivevhdsize>
      <jdrivevhdsize>10</jdrivevhdsize>
      <kdrivevhdsize>10</kdrivevhdsize>
      <ldrivevhdsize>10</ldrivevhdsize>
      <mdrivevhdsize>10</mdrivevhdsize>
  ...
  <managedaccounts>
    ...
    <![CDATA[
        <managedaccount>
             ]]><xsl:variable name="userdomainSPSSRS" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_SP_SSRS_USERNAME'],'\'))"></xsl:variable>
        <xsl:variable name="usernameSPSSRS" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_SP_SSRS_USERNAME'],'\'))"></xsl:variable>
        <xsl:variable name="passwordSPSSRS" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_SP_SSRS_PASSWORD']"></xsl:variable><![CDATA[    
  ...
  <sitecollections>
    ...
    <sitecollection>
     ...
     <sitecollection>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[/ediscovery</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
...
<!--    <defaultpermissionsuserpolicy>
  ...
  <noncontentdbs>
    ...
    <xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_INSTALL_SSRS'] = 'true'"><![CDATA[
     <noncontentdb>
...
<!-- This is a bit of a hack, but we need a sub folder for each instance as some servers host multiple instances -->
    ...
    <sqlagentjoblogging>\Agent Jobs Output</sqlagentjoblogging>
		...
		<sqlbackupdaystokeepbackups>3</sqlbackupdaystokeepbackups>
