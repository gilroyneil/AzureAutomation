...
<farm>
 ...
 <managedaccount>
    ...
    <xsl:variable name="passwordSPSearchSA" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_SSA_SP_SERVICE_PASSWORD']"></xsl:variable><![CDATA[    
      ...
      <displayname>]]><xsl:value-of select="$passwordSPSearchSA"/><![CDATA[</displayname>
      <passwordrequired>Yes</passwordrequired>
...
<productversion>
    ...
    <productversion>
      ...
      <producttype>Build Script</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\SP Scripts v3</binary>
    </productversion>
    <productversion>
      ...
      <producttype>Build Script</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\SharePoint\WSPs</binary>
    </productversion>
    <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\SharePoint\Server Media</binary>
      <exe>setup.exe</exe>
    ...
    <productversion>
			...
			<binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\SQL Server 2012 Std</binary>
			<exe>setup.exe</exe>
		</productversion>
    <productversion>
      ...
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\SSLNOPFX</binary>
    ...
    <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Language Packs\Spanish</binary>
      <exe>setup.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <producttype>Language Pack</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Language Packs\German</binary>
      <exe>setup.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <producttype>Language Pack</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Language Packs\Japanese</binary>
      <exe>setup.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <producttype>Language Pack</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Language Packs\French</binary>
      <exe>setup.exe</exe>
    </productversion>
    ...
    <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Cumulative Updates\Mar13</binary>
      <exe>ubersrvsp2013-kb2767999-fullfile-x64-glb.exe</exe>
    </productversion>

    <productversion>
      <product>Aug 2013 Cumulative Update</product>
      <install>Yes</install>
      <producttype>Cumulative Update</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\MediaShare\Cumulative Updates\Aug13</binary>
      <exe>ubersrv2013-kb2817616-fullfile-x64-glb.exe</exe>
    </productversion>
