...
<webAppDomain>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</webAppDomain>
<webAppDomainApps>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_SP_APP_URL_DOMAIN']"/><![CDATA[</webAppDomainApps>
...
<centralClusterLocation>]]><xsl:value-of select="//customeronboardingdata/QuorumShare"/><![CDATA[</centralClusterLocation>
  <makeADandDNSChanges_precreated>]]><xsl:value-of select="//clustersettings/precreated_sp/makeADandDNSChanges"/><![CDATA[</makeADandDNSChanges_precreated>
...
<doInstallBAI>False</doInstallBAI>
  <isHAInstall>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_HA']"/><![CDATA[</isHAInstall>
...
<contentdbinitialsize>10</contentdbinitialsize>
  ...
  <domaincreatesettings>
    <settings>
      <forestdomainname>sp.com</forestdomainname>
      <netbios>sp</netbios>
 ...
 <servergroups>
    ...
    <servergroupOLD>
      ...
      <cdrivevhdsize>80</cdrivevhdsize>
      <edrivevhdsize>60</edrivevhdsize>
      <fdrivevhdsize>80</fdrivevhdsize>
      <gdrivevhdsize>80</gdrivevhdsize>
...
<servergroup>
    ...
    <cdrivevhdsize>81</cdrivevhdsize>
      ...
      <fdrivevhdsize>0</fdrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <hdrivevhdsize>60</hdrivevhdsize>
      <idrivevhdsize>0</idrivevhdsize>
      <jdrivevhdsize>0</jdrivevhdsize>
      <kdrivevhdsize>0</kdrivevhdsize>
      <ldrivevhdsize>0</ldrivevhdsize>
...
<servergroup>
    ...
    <cdrivevhdsize>81</cdrivevhdsize>
      ...
      <fdrivevhdsize>0</fdrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <hdrivevhdsize>50</hdrivevhdsize>
      <idrivevhdsize>0</idrivevhdsize>
      <jdrivevhdsize>0</jdrivevhdsize>
      <kdrivevhdsize>0</kdrivevhdsize>
      <ldrivevhdsize>0</ldrivevhdsize>
...
<servergroup>
      ...
      <description>SQL Server to host Search and Others DBs</description>
      <needsexternalip>No</needsexternalip>
      <requirednumber>2</requirednumber>
      <orderednumber>2</orderednumber>
      <vmtemplate>Virtual-L</vmtemplate>
...
<servergroup>
    ...
    <servergroup>
      ...
      <cdrivevhdsize>100</cdrivevhdsize>
      <edrivevhdsize>100</edrivevhdsize>
      <fdrivevhdsize>200</fdrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <nicservice>x</nicservice>
      <nicoperations>x</nicoperations>
      <nicbackup>x</nicbackup>
...
<servergroup>
 ...
 <quotatemplate>
  ...
  <managedaccounts>
    ...
    <![CDATA[
        <managedaccount>
             ]]><xsl:variable name="userdomainSPSSRS" select="normalize-space(substring-before(//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
        <xsl:variable name="usernameSPSSRS" select="normalize-space(substring-after(//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
        <xsl:variable name="passwordSPSSRS" select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_SP_SERVICE_PASSWORD']"></xsl:variable><![CDATA[    
...
<sqlinstance>
  ...
  <webapplications>
   <webapplication>
      <name>Team</name>
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</url>
      ...
      <searchcrawlzoneconfiguration>No</searchcrawlzoneconfiguration>
       ...
       <webapplication>
      <name>Portal</name>
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_PORTALWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      ...
      <searchcrawlzoneconfiguration>No</searchcrawlzoneconfiguration>
       ...
       <webapplication>
      <name>Business</name>
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_BUSINESSWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>      
      ...
      <searchcrawlzoneconfiguration>No</searchcrawlzoneconfiguration>
       ...
       <webapplication>
      <name>Partner</name>
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_PARTNERWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
    ...
    <webapplication>
      <name>MySite</name>
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_MYSITESWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
  ...
  <sitecollections>
    <sitecollection>
      ...
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[/search</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <sitecollection>
      ...
      <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[/ediscovery</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <xsl:if test="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_SP_APP_URL_DOMAIN'] != ''">
      ...
      <sitecollection>
        <webapplication>Team</webapplication>
        <name>Apps</name>
        <url>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[/apps</url>
        <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
...
<productversion>
      <product>Mar 2015 Cumulative Update</product>
      <install>Yes</install>
      <producttype>Cumulative Update</producttype>
      <version>Default</version>
      <binary>]]><xsl:value-of select="$mediapath" /><![CDATA[\Cumulative Updates\Mar15</binary>
      <exe>ubersrv2013-kb2956166-fullfile-x64-glb.exe</exe>
      <searchstringwildcardtoknowifalreadyinstalled>KB2956166</searchstringwildcardtoknowifalreadyinstalled>
    </productversion>
  ...
  <userprofileservicesettings>
    ...
    <userprofileservicesetting>
      ...
      <mysitehostlocation>https://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_MYSITESWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</mysitehostlocation>      
  ...
  <searchsettings>
    <searchsetting>
      ...
      <searchcentreURL>https://]]><xsl:value-of select="normalize-space(//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL'])"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[/search/pages</searchcentreURL>
  ...
  <contentsource>
						  <type>SharePoint</type>
							<values>sps3s://]]><xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/>.<xsl:value-of select="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_WEB_APP_DOMAIN']"/><![CDATA[</values>
...
<backupandmaintenancesettings>
      <spbackupfilesharerootfolder_centralised>[subscriptionid]</spbackupfilesharerootfolder_centralised>
