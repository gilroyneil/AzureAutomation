...
<productversion>
      ...
      <![CDATA[
    <productversion>
      <product>BAI Longitude Search 5.1.12</product>
      <install>Yes</install>
      <producttype>BAI Longitude</producttype>
      <version>Default</version>
      <binary>]]><xsl:value-of select="$mediapath" /><![CDATA[\BAI\LS5.1.12T</binary>
      <exe></exe>
	...
	<productversion>
      <product>BAI Visual Refiners 2.3.11</product>
      <install>Yes</install>
      <producttype>BAI Longitude</producttype>
      <version>Default</version>
      <binary>]]><xsl:value-of select="$mediapath" /><![CDATA[\BAI\VR2.3.11T</binary>
      <exe></exe>
      <searchstringwildcardtoknowifalreadyinstalled></searchstringwildcardtoknowifalreadyinstalled>
    </productversion>
