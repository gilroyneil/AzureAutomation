...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <xsl:template match="farm">
    <![CDATA[<!-- AutoSPInstaller Sample Configuration File
...
<Configuration Environment="**||Environment||**" Version="**||VersionNumber||**" Hive="15" UseIPAddresses="False">
    ...
    <BuildAccountPassword>]]><xsl:value-of select="farm/managedaccounts/managedaccount[purpose='SharePoint Install Account']/password"/><![CDATA[</BuildAccountPassword>
		<TempFileLocationDuringInstall>C:\TempInstallFiles</TempFileLocationDuringInstall>
...
<BlobCacheLocation>]]><xsl:value-of select="farm/blobcachelocation"/><![CDATA[</BlobCacheLocation>  
        ...
        <!-- Which server(s) to provision CentralAdmin on. Specify "true" or a list of servers -->
         <CentralAdmin Provision="]]><xsl:choose>
          <xsl:when test="count(farm/servers/server[role='Web Server Group 2']) > 0">
            <xsl:for-each select="farm/servers/server[role='Web Server Group 2']">
    ...
    <Database>]]>
      ...
      <![CDATA[
        ...
        <xsl:when test="principalserver = '' or not(principalserver)">          
              <xsl:choose>
                  <xsl:when test="count(//servers/server[role='SQL Server for all DB Types']) > 0">
                      <xsl:value-of select="//servers/server[role='SQL Server for all DB Types'][1]/name"/>
                  </xsl:when>
                  <xsl:otherwise>
        ...
        <xsl:otherwise>
          <xsl:value-of select="principalserver"/>
      ...
      </xsl:choose>\<xsl:value-of select="name"/><![CDATA[</DBServer>
                ...
                <DataDrive>g</DataDrive>
                <LogsDrive>j</LogsDrive>
                <TempDBDataDrive>h</TempDBDataDrive>
                <TempDBLogsDrive>i</TempDBLogsDrive>
                <SystemDBDrive>m</SystemDBDrive>
                <BackupDrive>k</BackupDrive>
		<ClusterShareDrive>p</ClusterShareDrive>
				</Alias>]]>
		</xsl:for-each>
      <![CDATA[
      	</Aliases>
      ...
      <AlwaysOnSettings>
        ...
        <ListenerName>ESListener</ListenerName>
        <ListenerPort>3626</ListenerPort>
        <ClusterPort>5022</ClusterPort>
        <ClusterName>ESCluster</ClusterName>
      ...
      <OtherDBInitialSizeMB>3000</OtherDBInitialSizeMB>
             <SearchAnalyticsDBInitialSizeMB>250000</SearchAnalyticsDBInitialSizeMB>

      <PercentageLogSizeOfDataSize>50</PercentageLogSizeOfDataSize>
      ...
      <SearchBackupUNC>]]><xsl:value-of select="farm/searchbackuppath"/><![CDATA[</SearchBackupUNC>   -->
		...
		<ContentDBs>]]>
			...
			<xsl:variable
					...
					select="count(farm/sqlinstances/sqlinstance[type='Content'][primaryormirror='Primary'])">
					</xsl:variable>	
    ...
    <xsl:for-each select="//ContentDB">
          ...
          <![CDATA[<ContentDB type="WebApplication" name="]]><xsl:value-of select="Name"/><![CDATA[" WebApplication="]]><xsl:value-of select="WebApplication"/><![CDATA[" SQLAlias="SQLGEN_01_G1" SQLMirrorAlias="" />]]>
...
<Servers>]]>
    <xsl:for-each select="farm/servers/server">
      <xsl:variable
        ...
        <xsl:if test="name!=''">
          <![CDATA[
          <Server name="]]><xsl:value-of select="name"/><![CDATA[" ip="]]><xsl:value-of select="//serveripaddress[servername=$serverName]/serverip"/><![CDATA[" role="]]><xsl:value-of select="role"/><![CDATA[" addToDomain="]]><xsl:value-of select="addtodomain"/><![CDATA[" datacenter="]]><xsl:value-of select="datacenter"/><![CDATA[" appliance="]]><xsl:value-of select="appliance"/><![CDATA[" vmtemplate="]]><xsl:value-of select="deploymenttemplate"/><![CDATA[" startupScriptsRun="False" domainJoined="False" spInstalled="False" sqlInstalled="False" spFarmJoined="False"/>]]>
        </xsl:if>
   </xsl:for-each>
...
<ServerGroupSettings>]]>
    <xsl:for-each select="farm/servergroups/servergroup">
      <xsl:if test="name!=''">
        <![CDATA[
        <Server name="]]><xsl:value-of select="name"/><![CDATA[" description="]]><xsl:value-of select="description"/><![CDATA[" requiredNumber="]]><xsl:value-of select="requirednumber"/><![CDATA[" orderedNumber="]]><xsl:value-of select="orderednumber"/><![CDATA[" vmTemplate="]]><xsl:value-of select="vmtemplate"/><![CDATA[" cdrivevhdsizeGB="]]><xsl:value-of select="cdrivevhdsize"/><![CDATA[" edrivevhdsizeGB="]]><xsl:value-of select="edrivevhdsize"/><![CDATA[" fdrivevhdsizeGB="]]><xsl:value-of select="fdrivevhdsize"/><![CDATA[" gdrivevhdsizeGB="]]><xsl:value-of select="gdrivevhdsize"/><![CDATA[" hdrivevhdsizeGB="]]><xsl:value-of select="hdrivevhdsize"/><![CDATA[" jdrivevhdsizeGB="]]><xsl:value-of select="jdrivevhdsize"/><![CDATA[" kdrivevhdsizeGB="]]><xsl:value-of select="kdrivevhdsize"/><![CDATA[" ldrivevhdsizeGB="]]><xsl:value-of select="ldrivevhdsize"/><![CDATA[" mdrivevhdsizeGB="]]><xsl:value-of select="mdrivevhdsize"/><![CDATA[" ndrivevhdsizeGB="]]><xsl:value-of select="ndrivevhdsize"/><![CDATA[" pdrivevhdsizeGB="]]><xsl:value-of select="pdrivevhdsize"/><![CDATA[" nicservice="]]><xsl:value-of select="nicservice"/><![CDATA[" nicoperations="]]><xsl:value-of select="nicoperations"/><![CDATA[" nicbackup="]]><xsl:value-of select="nicbackup"/><![CDATA[" nicsqlreplication="]]><xsl:value-of select="nicsqlreplication"/><![CDATA[" nicdmzinternal="]]><xsl:value-of select="nicdmzinternal"/><![CDATA[" nicdmzexternal="]]><xsl:value-of select="nicdmzexternal"/><![CDATA["/>]]>
      </xsl:if>
    </xsl:for-each>
    ...
    <Services>
	 ...
	 <Serverroles>
        ...
        <xsl:choose>
          <xsl:when test="count(farm/servers/server[role='Web Server Group 2']) = 0 and count(farm/servers/server[role='Application Server Group 1']) = 0 and count(farm/servers/server[role='Application Server Group 2']) = 0 and count(farm/servers/server[role='Search Server Group 1']) = 0 and count(farm/servers/server[role='Search Server Group 2']) = 0 and count(farm/servers/server[role='Search Server Group 3']) = 0">
            <![CDATA[
            ...
            <![CDATA[
              <!-- This is a farm which has more than just Web Group 1 servers, so we need lots of conditional logic to figure out which services to start-->
                      ...
                      <!--Turn Off all Web Server Group 2 Services"-->
                        ...
                        <!-- We dont have any Web Group 2 Servers, this code is left in only for legacy updatability -->
                        <xsl:choose>
                          <xsl:when test="count(farm/servers/server[role='Web Server Group 2']) > 0">
    ...
    <![CDATA[ 
        ...
        <Serverrole name="Application Server Group 1">
         ...
         <Service Name="Word Automation Services" State="Start" Provision="false" ServiceInstanceType="Microsoft.Office.Word.Server.Service.WordServiceInstance"/>
          ...
          <xsl:choose>
            <xsl:when test="count(farm/servers/server[role='Application Server Group 2']) > 0">
              <![CDATA[
              <Service Name="Microsoft SharePoint Foundation Sandboxed Code Service" State="Stop" Provision="true" ServiceInstanceType="Microsoft.SharePoint.Administration.SPUserCodeServiceInstance"/>]]>
            </xsl:when>
            <xsl:otherwise>
	...
	<QuotaTemplates>
		<Quota Name="5MB" storageMax="5" storageWarning="4" usercodeMax="300" usercodeWarning="200" />				
    <Quota Name="250MB" storageMax="250" storageWarning="210" usercodeMax="300" usercodeWarning="200" />		
		<Quota Name="2GB" storageMax="2000" storageWarning="1600" usercodeMax="300" usercodeWarning="200" />
		<Quota Name="5GB" storageMax="5000" storageWarning="4000" usercodeMax="300" usercodeWarning="200" />
		<Quota Name="10GB" storageMax="10000" storageWarning="8000" usercodeMax="300" usercodeWarning="200" />
		<Quota Name="20GB" storageMax="20000" storageWarning="16000" usercodeMax="300" usercodeWarning="200" />
		<Quota Name="50GB" storageMax="50000" storageWarning="40000" usercodeMax="300" usercodeWarning="200" />
		<Quota Name="100GB" storageMax="100000" storageWarning="80000" usercodeMax="300" usercodeWarning="200"/>						
		<Quota Name="200GB" storageMax="200000" storageWarning="160000" usercodeMax="300" usercodeWarning="200" />
    </QuotaTemplates>
    ...
    <xsl:if test="farm/serviceapplications/serviceapplication[name='User Profile Service Application' and enable='Yes']">
      ...
      <!-- EnableNetBIOSDomainName should be set to true if the host portion of your DNS Domain name is different than your NetBIOS domain name.
        ...
        <UserProfileServiceApp Provision="true"
							   ...
							   <ProfileDB>]]><xsl:value-of select="//farmname"/><![CDATA[_UserProfile_svc</ProfileDB>
							   <SyncDB>]]><xsl:value-of select="//farmname"/><![CDATA[_UserProfileSync_svc</SyncDB>
							   <SocialDB>]]><xsl:value-of select="//farmname"/><![CDATA[_UserProfileSocial_svc</SocialDB>
							   <Connections>
							   ]]>
    ...
    <xsl:if test="farm/serviceapplications/serviceapplication[name='Search Service Application' and enable='Yes']">
            <![CDATA[
              <EnterpriseSearchService Provision="true"
				...
				<ProxySettings Address="]]><xsl:value-of select="normalize-space(//searchsettings/searchsetting/searchproxy)"/><![CDATA[" UseForFederated="]]><xsl:value-of select="//searchsettings/searchsetting/searchproxyforfederated"/><![CDATA[" />							                           
                  <EnterpriseSearchServiceApplications>
                      ...
                      <EnterpriseSearchServiceApplication Name="Search Service Application"
                                                          ...
                                                          DatabaseServer="]]><xsl:value-of select="//sqlinstances/sqlinstance[type='General']/aliasname"/><![CDATA["                                                          
                                                          FailoverDatabaseServer="]]><xsl:value-of select="//sqlinstances/sqlinstance[type='Search'][primaryormirror='Mirror']/aliasname"/><![CDATA["                        
                                                          Partitioned="false"
                                                          Partitions="]]><xsl:value-of select="number(//amountindexeditems) div number(10000000)"/><![CDATA["
          ...
          <![CDATA[
                          ...
                          <xsl:choose>
                            <xsl:when test="count(farm/servers/server[role='Application Server Group 1']) > 0">
                              <xsl:for-each select="farm/servers/server[role='Application Server Group 1']">
                                <xsl:variable
                                    name="serverName"
                                    select="name">
                                </xsl:variable>
...
<![CDATA[
    ...
    <xsl:for-each select="farm/noncontentdbs/noncontentdb">
        <xsl:if test="dbname!=''">
          <![CDATA[
	<SQLNonContentDB
						    DBName="]]><xsl:value-of select="//farm/farmname"/>_<xsl:value-of select="dbnamenoprefix"/><![CDATA["
    ...
    <![CDATA[
	      <SQLNonContentDB
						    DBName="]]><xsl:value-of select="//farm/farmname"/>_Search_svc<![CDATA["
