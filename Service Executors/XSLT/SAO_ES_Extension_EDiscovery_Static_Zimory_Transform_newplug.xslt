...
<farm>
  ...
  <numberofusers>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_NUMBEROFUSERS']"/><![CDATA[</numberofusers>
  <purpose>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PURPOSE']"/><![CDATA[</purpose>
  
  
  <farmname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[</farmname>
  ...
  <location>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_LOCATION']"/><![CDATA[</location>
  <customer>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERNAME']"/><![CDATA[</customer>
  <customerabreviation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/><![CDATA[</customerabreviation>
  <passphrase>1#]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[#1</passphrase>
  ...
  <amountindexeditems>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_AMOUNTINDEXEDITEMS']"/><![CDATA[</amountindexeditems>
  ...
  <domainjoinsettings>
    <settings>
      <shortdomainame>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DOMAINJOIN_SNAME']"/><![CDATA[</shortdomainame>
      <forestdomainname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DOMAINJOIN_FNAME']"/><![CDATA[</forestdomainname>
      <dcip>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DC_IP_ADDRESS']"/><![CDATA[</dcip>
      <username>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DOMAINJOIN_USERNAME']"/><![CDATA[</username>
      <password>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DOMAINJOIN_PASSWORD']"/><![CDATA[</password>
      <localadminpassword>Start123</localadminpassword>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_DOMAINJOIN_OU']"/><![CDATA[</ou>
    </settings>
  </domainjoinsettings>
  ...
  <managedaccounts>
    <managedaccount>
     ]]><xsl:variable name="userdomainSPIA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPIA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPIA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_INSTALL_PASSWORD']"></xsl:variable><![CDATA[  
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPFA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_FARM_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPFA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_FARM_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPFA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_FARM_PASSWORD']"></xsl:variable><![CDATA[      
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPWA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_WEB_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPWA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_WEB_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPWA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_WEB_PASSWORD']"></xsl:variable><![CDATA[      
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPSA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPSA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPSA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_SERVICE_PASSWORD']"></xsl:variable><![CDATA[    
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SERVER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SERVER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQL" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SERVER_PASSWORD']"></xsl:variable><![CDATA[       
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SRVA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SRVA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQLA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_SRVA_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLI" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_INST_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLI" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_INST_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQLI" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SQL_INST_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPCA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHEA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHEA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPCA" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHEA_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPCR" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCR" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPCR" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CACHER_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainCRAWL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CRAWL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameCRAWL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CRAWL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordCRAWL" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_CRAWL_PASSWORD']"></xsl:variable><![CDATA[ 
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainTSYS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_TSYSA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameTSYS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_TSYSA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordTSYS" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SP_TSYSA_PASSWORD']"></xsl:variable><![CDATA[     
  ...
  <webapplications>
    <webapplication>
      <name>Search</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[</url>
      ...
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <managedpaths>
    ...
    <managedpath/>
    <managedpath/>]]>
     <xsl:if test="//zim:set[@plugin='srv_ext_es_ediscovery']/zim:item[@name='ext_active'] = 'true'">
      <![CDATA[
    <managedpath>
      <webapplication>Search</webapplication>
  ...
  <sitecollections>
    <sitecollection>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[/sites/teamcollab</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <sitecollection>
      <webapplication>Search</webapplication>
      <name>Users</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[/userprofiles</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <xsl:if test="//zim:set[@plugin='srv_ext_es_ediscovery']/zim:item[@name='ext_active'] = 'true'">
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[/ediscovery</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <serviceapplicationsettings>
    <serviceapplicationsetting>
      ...
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
    <serviceapplicationsetting>
      <serviceapplicationname>Managed Metadata Service</serviceapplicationname>
      <settingname>TermStoreAdministrator</settingname>
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
<serviceapplicationsetting>
  ...
  <userprofileservicesettings>
   ...
   ]]><xsl:variable name="domainUPS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameUPS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordUPS" select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_PASSWORD']"></xsl:variable><![CDATA[     
    <userprofileservicesetting>
      <connectorname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_DOMAIN']"/><![CDATA[</connectorname>
      <forestname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_FOREST']"/><![CDATA[</forestname>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_OU']"/><![CDATA[</ou>
      <importfilter>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_PROFILE_Filter']"/><![CDATA[</importfilter>
      <useraccount>]]><xsl:value-of select="$usernameUPS"/><![CDATA[</useraccount>
      <password>]]><xsl:value-of select="$passwordUPS"/><![CDATA[</password>
      <mysitehostlocation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL']"/><![CDATA[/userprofiles</mysitehostlocation>
  ...
  <searchsettings>
    <searchsetting>
      ...
      <searchcentreURL>]]><xsl:value-of select="normalize-space(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL'])"/><![CDATA[/pages</searchcentreURL>
      <searchproxyforfederated>Yes</searchproxyforfederated>
    </searchsetting>
  </searchsettings>
  <contentsources>
  ]]>
    <xsl:variable name="hostonlysearchcentreurl" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_es']/zim:item[@name='_conf_SEARCHCENTERURL'],'://'))"></xsl:variable>
    <![CDATA[
  <contentsource>
