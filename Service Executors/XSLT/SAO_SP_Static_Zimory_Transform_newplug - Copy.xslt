...
<farm>
  ...
  <numberofusers>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_NUMBEROFUSERS']"/><![CDATA[</numberofusers>
  <purpose>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/><![CDATA[</purpose>
  
  
  <farmname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[</farmname>
  ...
  <location>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/><![CDATA[</location>
  <customer>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERNAME']"/><![CDATA[</customer>
  <customerabreviation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/><![CDATA[</customerabreviation>
  <passphrase>1#]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[#1</passphrase>
  ...
  <domainjoinsettings>
    <settings>
      <shortdomainame>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DOMAINJOIN_SNAME']"/><![CDATA[</shortdomainame>
      <forestdomainname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DOMAINJOIN_FNAME']"/><![CDATA[</forestdomainname>
      <dcip>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DC_IP_ADDRESS']"/><![CDATA[</dcip>
      <username>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DOMAINJOIN_USERNAME']"/><![CDATA[</username>
      <password>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DOMAINJOIN_PASSWORD']"/><![CDATA[</password>
<localadminpassword>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='_conf_DOMAINJOIN_LOCAL_ADMIN_PASSWORD']"/><![CDATA[</localadminpassword>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_DOMAINJOIN_OU']"/><![CDATA[</ou>
    </settings>
  </domainjoinsettings>
 ...
 <servergroups>
  ...
  <managedaccounts>
    <managedaccount>
     ]]><xsl:variable name="userdomainSPIA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPIA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_INSTALL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPIA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_INSTALL_PASSWORD']"></xsl:variable><![CDATA[  
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPFA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_FARM_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPFA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_FARM_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPFA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_FARM_PASSWORD']"></xsl:variable><![CDATA[      
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPWA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_WEB_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPWA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_WEB_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPWA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_WEB_PASSWORD']"></xsl:variable><![CDATA[      
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPSA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPSA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_SERVICE_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPSA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_SERVICE_PASSWORD']"></xsl:variable><![CDATA[    
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SERVER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SERVER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQL" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SERVER_PASSWORD']"></xsl:variable><![CDATA[       
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SRVA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SRVA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQLA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_SRVA_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLI" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_INST_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLI" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_INST_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSQLI" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SQL_INST_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPCA" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHEA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCA" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHEA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPCA" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHEA_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSPCR" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCR" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHER_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordSPCR" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CACHER_PASSWORD']"></xsl:variable><![CDATA[   
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainCRAWL" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CRAWL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameCRAWL" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CRAWL_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordCRAWL" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_CRAWL_PASSWORD']"></xsl:variable><![CDATA[ 
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainTSYS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_TSYSA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="usernameTSYS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_TSYSA_USERNAME'],'\'))"></xsl:variable>
    <xsl:variable name="passwordTSYS" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SP_TSYSA_PASSWORD']"></xsl:variable><![CDATA[     
  ...
  <xsl:for-each select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='serviceextensions']/serviceextension">
      <xsl:if test="name!=''">
        <![CDATA[
  ...
  <webapplications>
   <webapplication>
      <name>Team</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_Team_SPContent</contentDBPrefix>
      <numberContentDBs>1</numberContentDBs>
      <blobcachesize>1</blobcachesize>
      <sitetemplate>STS#1</sitetemplate>
      <quota>5GB</quota>
      <defaultauthprovider>Claims-NTLM</defaultauthprovider>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
      <searchcrawlzoneconfiguration>No</searchcrawlzoneconfiguration>
    </webapplication>
       <webapplication>
      <name>Portal</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PORTALWEBAPP_URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_Portal_SPContent</contentDBPrefix>
      <numberContentDBs>1</numberContentDBs>
      <blobcachesize>1</blobcachesize>
      <sitetemplate>STS#1</sitetemplate>
      <quota>5GB</quota>
      ...
      <searchcrawlzoneconfiguration>No</searchcrawlzoneconfiguration>
       ...
       <webapplication>
      <name>Sharing</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHARINGWEBAPP_URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_Sharing_SPContent</contentDBPrefix>
      <numberContentDBs>1</numberContentDBs>
      <blobcachesize>1</blobcachesize>
      <sitetemplate>STS#1</sitetemplate>
      <quota>5GB</quota>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONFWEBAPP_URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_Conf_SPContent</contentDBPrefix>
      <numberContentDBs>1</numberContentDBs>
      <blobcachesize>1</blobcachesize>
      <sitetemplate>STS#1</sitetemplate>
      <quota>5GB</quota>
    ...
    <webapplication>
      <name>MySite</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_MYSITESWEBAPP_URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      
      <contentDBPrefix>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_SHORTCUSTOMERNAME']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PURPOSE']"/>_<xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_LOCATION']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[_MySite_SPContent</contentDBPrefix>
      <numberContentDBs>1</numberContentDBs>
      <blobcachesize>1</blobcachesize>
  ...
  <sitecollections>
    <sitecollection>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_TEAMWEBAPP_URL']"/><![CDATA[/search</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <serviceapplicationsettings>
    <serviceapplicationsetting>
      ...
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN1']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
    <serviceapplicationsetting>
      <serviceapplicationname>Managed Metadata Service</serviceapplicationname>
      <settingname>TermStoreAdministrator</settingname>
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CUSTOMERADMIN2']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
<serviceapplicationsetting>
  ...
  <windowsfirewallsettings>
    ...
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
    ...
    <windowsfirewallsetting>
      ...
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL SP-Other DB Instances</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>3627</incomingport>
    ...
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5192</incomingport>
      <action>Allow</action>
      <direction>In</direction>
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Mirror Port 5192</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5192</incomingport>
    ...
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5229</incomingport>
      <action>Allow</action>
      <direction>In</direction>
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Mirror Port 5229</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5229</incomingport>
    ...
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5302</incomingport>
      <action>Allow</action>
      <direction>In</direction>
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Mirror Port 5302</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5302</incomingport>
    ...
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5403</incomingport>
      <action>Allow</action>
      <direction>In</direction>
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Mirror Port 5403</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5403</incomingport>
    ...
    <windowsfirewallsetting>
      ...
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Mirror Port 5024</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Server for Content DB's</role>
      <incomingport>5024</incomingport>
    ...
    <windowsfirewallsetting>
      <role>SQL Witness</role>
      <incomingport>1433</incomingport>
      <action>Allow</action>
      <direction>In</direction>
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Standard Port</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Witness</role>
      <incomingport>1433</incomingport>
    ...
    <windowsfirewallsetting>
      ...
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Browser Port</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Witness</role>
      <incomingport>5022</incomingport>
      ...
      <remoteip>any</remoteip>
      <protocol>TCP</protocol>
      <rulename>SQL Witness Port 5022</rulename>
    </windowsfirewallsetting>
    <windowsfirewallsetting>
      <role>SQL Witness</role>
      <incomingport>5022</incomingport>
 ...
 <productversion>
      <product>SQL Server</product>
      <install>Yes</install>
      <producttype>Pre Install Patch</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\PreReqs</binary>
      <exe>dotNetFx40_Full_x86_x64.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\PreReqs</binary>
      <exe>Windows6-1.1-KB2506143-x64.msu</exe>
    </productversion>
 ...
 <productversion>
      ...
      <producttype>Pre Install Patch</producttype>
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\Pre Install Hotfixes</binary>
      <exe>433385_intl_x64_zip.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\Pre Install Hotfixes</binary>
      <exe>NDP45-KB2759112-x64.exe</exe>
    </productversion>
 ...
 <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\Pre Install Hotfixes</binary>
      <exe>Windows8-RT-KB2765317-x64.msu</exe>
    </productversion>
 ...
 <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint\Pre Install Hotfixes</binary>
      <exe>Windows6.1-KB2708075-x64.msu</exe>
    </productversion>


  <userprofileservicesettings>
  
   ]]><xsl:variable name="domainUPS" select="normalize-space(substring-before(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_USERNAME'],'\'))"></xsl:variable>
  <xsl:variable name="usernameUPS" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_USERNAME'],'\'))"></xsl:variable>
  <xsl:variable name="passwordUPS" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_PASSWORD']"></xsl:variable><![CDATA[     
    <userprofileservicesetting>
      <connectorname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_DOMAIN']"/><![CDATA[</connectorname>
      <forestname>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_FOREST']"/><![CDATA[</forestname>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_OU']"/><![CDATA[</ou>
      <importfilter>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_PROFILE_Filter']"/><![CDATA[</importfilter>
      <useraccount>]]><xsl:value-of select="$usernameUPS"/><![CDATA[</useraccount>
      <password>]]><xsl:value-of select="$passwordUPS"/><![CDATA[</password>
      <mysitehostlocation>]]><xsl:value-of select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_MYSITESWEBAPP_URL']"/><![CDATA[</mysitehostlocation>
  ...
  <searchsettings>
    <searchsetting>
      ...
      <searchcentreURL>]]><xsl:value-of select="normalize-space(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_TEAMWEBAPP_URL'])"/><![CDATA[/search/pages</searchcentreURL>
      <searchproxyforfederated>Yes</searchproxyforfederated>
    </searchsetting>
  </searchsettings>
  <contentsources>
  ]]>    
    <xsl:variable name="hostonlysearchcentreurl" select="normalize-space(substring-after(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_TEAMWEBAPP_URL'],'://'))"></xsl:variable>
    <![CDATA[
  <contentsource>
    ...
    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_WEB']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_WEB']"/>
        <xsl:with-param name="type" select="'Web'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_FILE']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_FILE']"/>
        <xsl:with-param name="type" select="'File'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_BUSINESS']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_BUSINESS']"/>
        <xsl:with-param name="type" select="'Business'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="normalize-space(//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_SP']) != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='srv_base_sp']/zim:item[@name='_conf_CONTENT_SP']"/>
