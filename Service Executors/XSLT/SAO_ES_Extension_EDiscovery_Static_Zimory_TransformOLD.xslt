<!--
Author: Neil Gilroy
Filename: SAO_ES_Extension_EDiscovery_Static_Zimory_Transform.xslt
Created: December 2012
Purpose: To Transform the Zimory XML Input into a XML schema needed for the SP Scripts.
-->
...
<farm>
  ...
  <numberofusers>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Number of Users']"/><![CDATA[</numberofusers>
  <purpose>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Purpose']"/><![CDATA[</purpose>
  
  
  <farmname>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Short Customer Name']"/>_<xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Purpose']"/>_<xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Location']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[</farmname>
  ...
  <location>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Location']"/><![CDATA[</location>
  <customer>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Name']"/><![CDATA[</customer>
  <customerabreviation>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Short Customer Name']"/><![CDATA[</customerabreviation>
  <passphrase>1#]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Short Customer Name']"/>_<xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Purpose']"/>_<xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Location']"/>_<xsl:value-of select="//customerandenvironmentsettings/farmnumber"/><![CDATA[#1</passphrase>
  ...
  <amountindexeditems>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Amount of Indexed Items']"/><![CDATA[</amountindexeditems>
  ...
  <blobcachelocation>C:\BlobCache\</blobcachelocation>
  ...
  <domainjoinsettings>
    <settings>
      <shortdomainame>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Short Domain Name']"/><![CDATA[</shortdomainame>
      <forestdomainname>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Domain Name']"/><![CDATA[</forestdomainname>
      <dcip>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='DC IP Address']"/><![CDATA[</dcip>
      <username>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Domain Join Username']"/><![CDATA[</username>
      <password>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Domain Join Password']"/><![CDATA[</password>
      <localadminpassword>Start123</localadminpassword>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Domain Join OU']"/><![CDATA[</ou>
    </settings>
  </domainjoinsettings>
  ...
  <vmtemplates>
    <vmtemplate>
      ...
      <performanceunits>4</performanceunits>
      <cores>2</cores>
      <ram>4096</ram>
    ...
    <vmtemplate>
      ...
      <performanceunits>12</performanceunits>
      <cores>4</cores>
      <ram>16384</ram>
      <externalip>Yes</externalip>
    </vmtemplate>
  ...
  <servergroups>
   <servergroup>
    ...
    <servergroup>
      ...
      <description>All Service Apps and Search component apart from index</description>
      <requirednumber>2</requirednumber>
      <orderednumber>2</orderednumber>
      <vmtemplate>Virtual-M</vmtemplate>
      <cdrivevhdsize/>
    ...
    <servergroup>
      ...
      <description>Crawl and Admin servers</description>
      <requirednumber>0</requirednumber>
      <orderednumber>2</orderednumber>
      <vmtemplate>Virtual-M</vmtemplate>
      <cdrivevhdsize/>
      <edrivevhdsize>100</edrivevhdsize>
      <fdrivevhdsize>25</fdrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <nicservice>x</nicservice>
      <nicoperations>x</nicoperations>
      <nicbackup>x</nicbackup>
    ...
    <servergroup>
      ...
      <description>Processing Servers (APC, CPC and QPC)</description>
      <requirednumber>0</requirednumber>
      <orderednumber>2</orderednumber>
      <vmtemplate>Virtual-M</vmtemplate>
      <cdrivevhdsize/>
    ...
    <servergroup>
      ...
      <description>Index Servers</description>
      <requirednumber>0</requirednumber>
      <orderednumber>2</orderednumber>
      <vmtemplate>Virtual-M</vmtemplate>
      <cdrivevhdsize/>
    ...
    <servergroup>
      ...
      <idrivevhdsize/>
      <jdrivevhdsize/>
      <kdrivevhdsize>50</kdrivevhdsize>
      <ldrivevhdsize>25</ldrivevhdsize>
      <mdrivevhdsize>25</mdrivevhdsize>
  ...
  <managedaccounts>
    <managedaccount>
     ]]><xsl:variable name="userdomainSPIA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Install Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPIA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Install Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPIA" select="normalize-space(substring-before($usernameandpasswordSPIA,':'))"></xsl:variable>
    <xsl:variable name="passwordSPIA" select="normalize-space(substring-after($usernameandpasswordSPIA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
    ]]><xsl:variable name="userdomainSPFA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Farm Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPFA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Farm Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPFA" select="normalize-space(substring-before($usernameandpasswordSPFA,':'))"></xsl:variable>
    <xsl:variable name="passwordSPFA" select="normalize-space(substring-after($usernameandpasswordSPFA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
     ]]><xsl:variable name="userdomainSPWA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Web Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPWA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Web Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPWA" select="normalize-space(substring-before($usernameandpasswordSPWA,':'))"></xsl:variable>
    <xsl:variable name="passwordSPWA" select="normalize-space(substring-after($usernameandpasswordSPWA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainSPSA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Service App Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPSA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Service App Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPSA" select="normalize-space(substring-before($usernameandpasswordSPSA,':'))"></xsl:variable>
    <xsl:variable name="passwordSPSA" select="normalize-space(substring-after($usernameandpasswordSPSA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
     ]]><xsl:variable name="userdomainSQL" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Server Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQL" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Server Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQL" select="normalize-space(substring-before($usernameandpasswordSQL,':'))"></xsl:variable>
    <xsl:variable name="passwordSQL" select="normalize-space(substring-after($usernameandpasswordSQL,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
         ]]><xsl:variable name="userdomainSQLA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Agent Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQLA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Agent Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLA" select="normalize-space(substring-before($usernameandpasswordSQLA,':'))"></xsl:variable>
    <xsl:variable name="passwordSQLA" select="normalize-space(substring-after($usernameandpasswordSQLA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
             ]]><xsl:variable name="userdomainSQLI" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Install Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSQLI" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SQL Install Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSQLI" select="normalize-space(substring-before($usernameandpasswordSQLI,':'))"></xsl:variable>
    <xsl:variable name="passwordSQLI" select="normalize-space(substring-after($usernameandpasswordSQLI,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
                ]]><xsl:variable name="userdomainSPCA" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Cache Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPCA" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Cache Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCA" select="normalize-space(substring-before($usernameandpasswordSPCA,':'))"></xsl:variable>
    <xsl:variable name="passwordSPCA" select="normalize-space(substring-after($usernameandpasswordSPCA,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
    ]]><xsl:variable name="userdomainSPCR" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Cache Reader Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordSPCR" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Cache Reader Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameSPCR" select="normalize-space(substring-before($usernameandpasswordSPCR,':'))"></xsl:variable>
    <xsl:variable name="passwordSPCR" select="normalize-space(substring-after($usernameandpasswordSPCR,':'))"></xsl:variable><![CDATA[
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainCRAWL" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Crawl Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordCRAWL" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Crawl Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameCRAWL" select="normalize-space(substring-before($usernameandpasswordCRAWL,':'))"></xsl:variable>
    <xsl:variable name="passwordCRAWL" select="normalize-space(substring-after($usernameandpasswordCRAWL,':'))"></xsl:variable><![CDATA[
...
<domain>]]><xsl:value-of select="$userdomainCRAWL"/><![CDATA[</domain>
    ...
    <managedaccount>
      ]]><xsl:variable name="userdomainTSYS" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP TSYS Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameandpasswordTSYS" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP TSYS Admin Account'],'\'))"></xsl:variable>
    <xsl:variable name="usernameTSYS" select="normalize-space(substring-before($usernameandpasswordTSYS,':'))"></xsl:variable>
    <xsl:variable name="passwordTSYS" select="normalize-space(substring-after($usernameandpasswordTSYS,':'))"></xsl:variable><![CDATA[
  ...
  <webapplications>
    <webapplication>
      <name>Search</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL']"/><![CDATA[</url>
      <serviceapplicationproxygroup>Default</serviceapplicationproxygroup>
      <contentDBPrefix>ES_PRO_DE_01_Search_SPContent</contentDBPrefix>
      ...
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <managedpaths>
    ...
    <managedpath/>]]>
    <xsl:if test="//zim:set[@plugin='SAO-ES-EDiscovery']">
      <![CDATA[
    <managedpath>
      <webapplication>Search</webapplication>
  ...
  <sitecollections>
    <sitecollection>
      ...
      <url>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL']"/><![CDATA[/sites/teamcollab</url>
      <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
    ...
    <sitecollection>
      <webapplication>Search</webapplication>
      <name>Users</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL']"/><![CDATA[/userprofiles</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
      ...
      <xsl:if test="//zim:set[@plugin='SAO-ES-EDiscovery']">
        ...
        <sitecollection>
      <webapplication>Search</webapplication>
      <name>eDiscovery Home</name>
      <url>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL']"/><![CDATA[/ediscovery</url>
         <primarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 1']"/><![CDATA[</primarysitecollectionadmin>
      <secondarysitecollectionadmin>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 2']"/><![CDATA[</secondarysitecollectionadmin>
  ...
  <serviceapplicationsettings>
    <serviceapplicationsetting>
      ...
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 1']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
    <serviceapplicationsetting>
      <serviceapplicationname>Managed Metadata Service</serviceapplicationname>
      <settingname>TermStoreAdministrator</settingname>
      <settingvalue>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Customer Admin 2']"/><![CDATA[</settingvalue>
    </serviceapplicationsetting>
<serviceapplicationsetting>
  ...
  <productversions>
    ...
    <productversion>
      ...
      <version>Default</version>
      <binary>\\]]><xsl:value-of select="//customerandenvironmentsettings/mediaserver"/><![CDATA[\Solution Artifacts\Binary Package\Installation Media\RTM\SharePoint</binary>
      <exe>setup.exe</exe>
      <license>6RNT8-XV26M-GWH36-VMGQH-94MMH</license>
    </productversion>
    <productversion>
  ...
  <userprofileservicesettings>
   ]]><xsl:variable name="domainUPS" select="normalize-space(substring-before(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import Account'],'\'))"></xsl:variable>
  <xsl:variable name="usernameandpasswordUPS" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import Account'],'\'))"></xsl:variable>
  <xsl:variable name="usernameUPS" select="normalize-space(substring-before($usernameandpasswordUPS,':'))"></xsl:variable>
  <xsl:variable name="passwordUPS" select="normalize-space(substring-after($usernameandpasswordUPS,':'))"></xsl:variable><![CDATA[
    <userprofileservicesetting>
      <connectorname>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import Domain']"/><![CDATA[</connectorname>
      <forestname>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import Forest']"/><![CDATA[</forestname>
      <ou>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import OU']"/><![CDATA[</ou>
      <importfilter>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Profile Import Filter']"/><![CDATA[</importfilter>
      <useraccount>]]><xsl:value-of select="$usernameUPS"/><![CDATA[</useraccount>
      <password>]]><xsl:value-of select="$passwordUPS"/><![CDATA[</password>
      <mysitehostlocation>]]><xsl:value-of select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL']"/><![CDATA[/userprofiles</mysitehostlocation>
  ...
  <searchsettings>
    <searchsetting>
      ...
      <queryindexlocation>c:\SharePointIndex</queryindexlocation>
  ...
  <contentsources>
    ...
    <xsl:variable name="hostonlysearchcentreurl" select="normalize-space(substring-after(//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Search Center URL'],'://'))"></xsl:variable>
    <![CDATA[
  <contentsource>
    ...
    <xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Web Content Sources'] != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Web Content Sources']"/>
        <xsl:with-param name="type" select="'Web'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='File Content Sources'] != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='File Content Sources']"/>
        <xsl:with-param name="type" select="'File'"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Business Content Sources'] != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='Business Content Sources']"/>
        <xsl:with-param name="type" select="'Business'"/>
      </xsl:call-template>
    </xsl:if>

    <xsl:if test="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Content Sources'] != ''">
      <xsl:call-template name="csource">
        <xsl:with-param name="text" select="//zim:set[@plugin='SAO-ES-Base']/zim:item[@name='SP Content Sources']"/>
  ...
  <noncontentdbs>
    ...
    <noncontentdb>
      <db>Search_svc</db>
      <dbname>ES_PRO_DE_01_Search_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
    </noncontentdb>
    <noncontentdb>
      <db>SearchCrawlStore1_svc</db>
      <dbname>ES_PRO_DE_01_SearchCrawlStore1_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
    ...
    <noncontentdb>
      <db>SearchCrawlStore2_svc</db>
      <dbname>ES_PRO_DE_01_SearchCrawlStore2_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
    ...
    <noncontentdb>
      <db>SearchLinks_svc</db>
      <dbname>ES_PRO_DE_01_SearchLinks_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
    ...
    <noncontentdb>
      <db>SearchAnalyticsReporting1_svc</db>
      <dbname>ES_PRO_DE_01_SearchAnalyticsReporting1_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
    ...
    <noncontentdb>
      <db>SearchAnalyticsReporting2_svc</db>
      <dbname>ES_PRO_DE_01_SearchAnalyticsReporting2_svc</dbname>
      <serviceapplicationname>Search Service</serviceapplicationname>
      <precreate>No</precreate>
      <primarysqlalias>SQLGEN_01_G1</primarysqlalias>
      <availabilitygroup>Default</availabilitygroup>
