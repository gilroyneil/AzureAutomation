...
<doInstallBAI>False</doInstallBAI>
  ...
  <devseat>]]><xsl:choose>
      <xsl:when test="//zim:set[@plugin='SAO-SP-Base']/zim:item[@name='_conf_PURPOSE'] = 'DES' and //customerandenvironmentsettings/supportDevSeat = 'True'">True</xsl:when>      
...
<servergroup>
    ...
    <cdrivevhdsize>81</cdrivevhdsize>
      ...
      <fdrivevhdsize>0</fdrivevhdsize>
      <gdrivevhdsize>0</gdrivevhdsize>
      <hdrivevhdsize>90</hdrivevhdsize>
      <idrivevhdsize>0</idrivevhdsize>
      <jdrivevhdsize>0</jdrivevhdsize>
      <kdrivevhdsize>0</kdrivevhdsize>
      <ldrivevhdsize>0</ldrivevhdsize>
